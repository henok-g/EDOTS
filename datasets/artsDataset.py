...
class artsDataset(baseDetectionDataset):
    def __init__(self, root):
        super().__init__(root)

    def load_image(self):
        # Implementation for loading images specific to artsDataset
        pass

    def load_annotations(self):
        # Implementation for loading annotations specific to artsDataset
        pass
